        ...
        >
          {capsule ? (
            <View className="flex-row items-center">
              <AirplaneAnimation />
              <Text className="text-2xl font-display font-medium tracking-tight text-white">{capsule.name}</Text>
            </View>
          ) : (
            <View>
        ...
        >
          <View>
            ...
            <Text className="text-muted-foreground text-white">
              {isCuratorMode
                ? `Add the places you recommend for your friends`
                : `Add each set of recs received from friends`}
            </Text>
